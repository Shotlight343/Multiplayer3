...
public class MultiplayerMenu : NetworkBehaviour
{
    ...
    //it tells unity to use secure websockets but if the relay data uses UDP, the connection will fail
    //if
    ...
    public async void StartHost()
        //start a server and create a room code for the clients to join
    {
        try
        {
